...
import { MapPin, Banknote, Eye, ChevronDown, Plus, Building2, Calendar, Users } from 'lucide-react';
...
export function JobsContent({ children }: JobsContentProps) {
    ...
    <MainLayout>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          ...
          <button
            onClick={() =>
              updateFilter('isRecruiting', isRecruiting === 'true' ? null : 'true')
            }
            className={`px-3 py-1.5 text-sm rounded-full transition-colors ${
              isRecruiting === 'true'
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12 text-destructive">구인공고를 불러올 수 없습니다.</div>
        ) : !data?.data?.length ? (
